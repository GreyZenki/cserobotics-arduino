...
function: draw two black bold lines on white paper. keep the sensor in between two lines.
...
*****************************************/
#define trackingPin 7 //the tracking module attach to pin 7
#define ledPin 13 //pin13 built-in led
